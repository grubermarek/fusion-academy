...
(function(){
  ...
  const DICT = {
    sk:{
      ...
      'settings.save_all':'Uložiť nastavenia',
      'settings.language':'Jazyk','settings.birthday':'Dátum narodenia',
    ...
    cs:{
      ...
      'settings.save_all':'Uložit nastavení',
      'settings.language':'Jazyk','settings.birthday':'Datum narození',
    ...
    en:{
      ...
      'settings.language':'Language','settings.birthday':'Date of birth',
    ...
    uk:{
      ...
      'settings.save_all':'Зберегти налаштування',
      'settings.language':'Мова','settings.birthday':'Дата народження',
    ...
    hu:{
      ...
      'settings.save_all':'Beállítások mentése',
      'settings.language':'Nyelv','settings.birthday':'Születési dátum',
    ...
    de:{
      ...
      'settings.save_all':'Einstellungen speichern',
      'settings.language':'Sprache','settings.birthday':'Geburtsdatum',
